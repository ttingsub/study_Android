...
public class SoccerAdapter extends
        RecyclerView.Adapter<SoccerAdapter.ViewHolder>
                    implements com.example.my31_recyclerview3.OnSingerItemClickListener {
    private static final String TAG = "main:SingerAdapter";

    // 1. 리스너 선언
    com.example.my31_recyclerview3.OnSingerItemClickListener listener;
    ...
    public SoccerAdapter(ArrayList<SoccerDto> dtos, Context context) {
        this.dtos = dtos;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = inflater.inflate(R.layout.soccer,
                                                parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        SoccerDto dto = dtos.get(position);
    ...
    public void addDto(SoccerDto dto){
        dtos.add(dto);
    }
    ...
    public SoccerDto getItem(int position){
        return dtos.get(position);
    }

    //4. 메인에서 클릭리스너를 클릭했을때 어댑터의 리스너와 연결해준다
    public void setOnItemClickListener(com.example.my31_recyclerview3.OnSingerItemClickListener listener){
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView, com.example.my31_recyclerview3.OnSingerItemClickListener listener) {
            super(itemView);

            parentLayout = itemView.findViewById(R.id.parentLayout);
            tvName = itemView.findViewById(R.id.tvName);
            tvMobile = itemView.findViewById(R.id.tvTeam);
        ...
        public void setDto(SoccerDto dto){
            tvName.setText(dto.getName());
            tvMobile.setText(dto.getTeam());
